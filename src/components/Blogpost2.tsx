        ...
        <div id="container">
          ...
          <div id="wrapper">
            <div>
              ...
              <p>
                <strong>ทฤษฎีระบบ</strong>
              </p>
              <p>
                System Theory เป็นแนวคิดที่มององค์การเป็นระบบเปิดที่ซับซ้อน
              ...
              <p>
                <ol className="ml-4">
                  <li>
                    1. องค์การเป็นระบบที่มีขอบเขต Inputs วัตถุดิบ Suppliers
              ...
              <p>
                <ol className="ml-4">
                  ...
                  <li>
                    7. ข้อดี ข้อเสียของ Model ข้อดี คือเป็น Model ที่เข้าใจง่าย
