          ...
          <div className="blog-entries">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      และเทคโนโลยีปัญญาประดิษฐ์มาใช้ในการบริหารจัดการองค์การเพื่อการให้บริการแก่ประชาชน
                    </p>
                    <a
            ...
            <div className="card mb-4">
                ...
                <div className="row">
                  ...
                  <div className="col-lg-6">
                    ...
                    <p className="card-text">
                      ...
                      เพื่ิอการพัฒนาคุณภาพการบริหารจัดการภาครัฐในยุคดิจิทัลและ
                      AI
                    </p>
                    <a
              ...
              <div className="card-footer text-muted">
                ...
                <a href="#">สองนคร รัตนบุรี</a>
                <div className="col-lg-6">
                  <h2 className="card-title">Digital Process Redesign</h2>0
                  <p className="card-text">
