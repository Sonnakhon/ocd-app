        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <hr />
              {/* Date/Time */}
              <p>โพสต์เมื่อวันที่ 18 ธันวาคม 2567 โดยสองนคร รัตนบุรี </p>
              <hr />
              {/* Post Content */}
              ...
              <p>
                ธรรมชาติของ OD คือ (The Nature of OD)
                <ol className="ml-4" style={{ listStyleType: "deciml" }}>
                  <li>
                    OD เกี่ยวข้องศาสตร์หลายแขนง โดยมี Behavioral Sciences
                    เป็นแกนกลางหรือแกนหลัก (Social Psychology)
                  </li>
              ...
              <p>
                ลักษณะของ OD ได้แก่ (The Nature of OD)
                <ol className="ml-4" style={{ listStyleType: "deciml" }}>
                  <li>
              ...
              <p>
                จะต้องอยู่บนรากฐานของความรู้และค่านิยม ดังนี้
                <ol className="ml-4" style={{ listStyleType: "deciml" }}>
                  <li>
              ...
              <p>
                รูปแบบในการพัฒนาองค์การ: OD ได้แก่
                <ol className="ml-4" style={{ listStyleType: "deciml" }}>
                  <li>
                    ...
                    <ul className="">
                      1.1.1 Unfreezing: การเตรียมพร้อมกับการเปลี่ยนแปลง
                  ...
                  <li>
                    ...
                    <ul className="">
                      ...
                      <ul className="">
                        1. การกำหนดประเด็น (En-tering)<ul className=""></ul>
                        1.1
                        ...
                        <ul>
                          3. การวางแผนและปฏิบัติตามแผน (Planning and
                          Implementing Change)
                        </ul>
              ...
              <p>
                ...
                <ul className="ml-4" style={{ listStyleType: "circle" }}>
                  <li>เหมือนมนุษย์ที่กำลังป่วย</li> <li>ภาวะขาดทุน</li>
